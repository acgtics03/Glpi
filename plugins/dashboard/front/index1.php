...
if($sel_ent == '' OR strstr($sel_ent,",")) { 	
	$ent_name = __('Estadísticas de Tickets','dashboard');
}
	...
	$ent_name = __('Estadísticas de Tickets','dashboard')." :  ". $ent_name1 ;
}
...
$_SESSION['charts_colors'] = $colors;
    ...
    switch (date("m")) {
	    case "01": $mes = __('Enero','dashboard'); break;
	    case "02": $mes = __('Febrero','dashboard'); break;
	    case "03": $mes = __('Marzo','dashboard'); break;
	    case "04": $mes = __('Abril','dashboard'); break;
	    case "05": $mes = __('Mayo','dashboard'); break;
	    case "06": $mes = __('Junio','dashboard'); break;
	    case "07": $mes = __('Julio','dashboard'); break;
	    case "08": $mes = __('Agosto','dashboard'); break;
	    case "09": $mes = __('Septiembre','dashboard'); break;
	    case "10": $mes = __('Octubre','dashboard'); break;
	    case "11": $mes = __('Noviembre','dashboard'); break;
	    case "12": $mes = __('Diciembre','dashboard'); break;
    }

   switch (date("w")) {
	    case "0": $dia = __('Domingo','dashboard'); break;    
	    case "1": $dia = __('Lunes','dashboard'); break;
	    case "2": $dia = __('Martes','dashboard'); break;
	    case "3": $dia = __('Miércoles','dashboard'); break;
	    case "4": $dia = __('Jueves','dashboard'); break;
	    case "5": $dia = __('Viernes','dashboard'); break;
	    case "6": $dia = __('Sábado','dashboard'); break;  
    }
...
<html>
<head>
    <title>GLPI - Reportes - Inicio</title>
...
<script type="text/javascript">
          ...
          <!-- Brand and toggle get grouped for better mobile display -->
           <div class="navbar-header" style="color:#fff;" >
               <a class="navbar-brand hidden-xs" href="<?php echo $CFG_GLPI['url_base'].'/front/ticket.php';?>" target="_blank" style="width: 290px; margin-left: -55px; margin-top:-2px;">
                  ...
                  <span style="font-size:12px;"><?php echo '<img src='. $photo_url .' alt="" title="Upload photo in user profile" class="avatar" style="height: 40px; margin-left: 0px; " />&nbsp;&nbsp;'; ?><?php echo $_SESSION["glpifirstname"];?></span>                  
                	</a>          	
           </div>
				<!-- NAVBAR LEFT  -->					
 ...
 <!-- alert(curr_day);	-->
                                ...
                                dayn[6] = "Sábado";
                                dayn[7] = "Domingo";
                                var ds = dayn[d.getDay()];
                                
                                <!-- alert(curr_day + " " + ds);-->							
							
							    var NameMonthSpanish = curr_month;
                                var month = new Array();
                                month[0] = "Enero";
                                month[1] = "Febrero";
                                month[2] = "Marzo";
								...
								document.write("<i class='fa fa-calendar' style='color:#fff;'> </i><span style='font-size:14px;'>  " + ds + ", " + curr_date + " " + n + " del " + curr_year +"</span>" );
...
<!-- Demo navbar -->
    <div class="navbar yamm navbar-default nav-delighted" id="menuHeader"> 
        ...
        <div id="navbar-collapse-1" class="navbar-collapse collapse">
          ...
          <li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1" onclick="location.href=('index.php')"><i class='fa fa-dashboard'></i>&nbsp; Tablero</span></a></li>
		  <!-- <li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1" onclick="window.open('./graphs/graf_tech.php?con=1','iframe1');"><i class='fa fa-area-chart'></i>&nbsp; <?php echo __('Mi Tablero','dashboard');?></span></a></li>-->
           ...
           <!-- Classic dropdown -->            
            <li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-edit'></i>&nbsp;<?php echo __('Tickets','dashboard');?>&nbsp;<b class="caret"></b></span></a>
              <ul role="menu" class="dropdown-menu">
                <li><a tabindex="-1" href="./tickets/chamados.php" target="_blank"> <?php echo __('General','dashboard'); ?> </a></li>
                <!-- <li><a tabindex="-1" href="./tickets/select_ent.php" target="_blank"> <?php echo __('Por Entidad','dashboard'); ?> </a></li>
                <li><a tabindex="-1" href="./tickets/select_grupo.php" target="_blank">  <?php echo __('Por Grupo','dashboard'); ?> </a></li>                
                <li><a tabindex="-1" href="./map/index.php" target="_blank"> <?php echo __('Map','dashboard'); ?> </a></li> 
                <li class="dropdown-submenu">
       			   <a tabindex="-1" href="#"><?php echo __('Mapa','dashboard'); ?></a>
	               <ul class="dropdown-menu">
	                  <li><a href="./map/index.php" target="_blank" > <?php echo __('Por Entidad','dashboard'); ?> </a></li>
	                  <li><a href="./map/map_loc.php" target="_blank" > <?php echo __('Por Ubicación','dashboard'); ?> </a></li>							   
	               </ul>
	            </li> -->
              </ul>
            </li>            
            ...
            <!-- Classic list -->
			<li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-file-text'></i>&nbsp;<?php echo __('Reportes','dashboard');?>&nbsp;<b class="caret"></b></span></a>
                  ...
                  <div class="yamm-content" style="width:400px;">
                    <div class="row">
                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
                       <li>
                        ...
                        <li><a href="./reports/rel_tecnicos.php?con=1" target="iframe1" > <?php echo _sn('Technician','Technicians',2,'dashboard'); ?> </a></li>
				               ...
				               <ul class="dropdown-menu">
									<li><a href="./reports/rel_custo_ent.php" target="iframe1" style="color:#000;"> <?php echo __('Por Entidad','dashboard'); ?> </a></li>
									<li><a href="./reports/rel_custo_tec.php" target="iframe1" style="color:#000;"> <?php echo __('Por Técnnico','dashboard'); ?> </a></li>
									<li><a href="./reports/rel_custo_req.php" target="iframe1" style="color:#000;"> <?php echo __('Por Respuesta','dashboard'); ?> </a></li>   
									<li><a href="./reports/rel_custo_loc.php" target="iframe1" style="color:#000;"> <?php echo __('Por Ubicación','dashboard'); ?> </a></li>
				               </ul>
				             </li> 
								<li class="dropdown-submenu">
							   <a tabindex="-1" href="#"><?php echo __('Summary','dashboard'); ?></a>
				               <ul class="dropdown-menu">
									<li><a href="./reports/rel_sint_all.php" target="iframe1" style="color:#000;"> <?php echo __('General','dashboard'); ?> </a></li>
									<li><a href="./reports/rel_sint_ent.php" target="iframe1" style="color:#000;"> <?php echo __('Por Entidad','dashboard'); ?> </a></li>
									<li><a href="./reports/rel_sint_tec.php" target="iframe1" style="color:#000;"> <?php echo __('Por Técnico','dashboard'); ?> </a></li>
									<li><a href="./reports/rel_sint_req.php" target="iframe1" style="color:#000;"> <?php echo __('Por Respuesta','dashboard'); ?> </a></li>   
				               </ul>
				             </li> 
				               ...
				               <ul class="dropdown-menu">
									...
									<li><a href="./reports/rel_tarefa_cham.php" target="iframe1" style="color:#000;"> <?php echo  __('ver','dashboard'); ?> </a></li>   
									<li><a href="./reports/rel_task_ent.php" target="iframe1" style="color:#000;"> <?php echo  __('Entidad','dashboard'); ?> </a></li>   
				               </ul>
				             </li>				             
                      </ul>
                      ...
                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;"> 
                        <li>
                          <!-- <p><strong>Links Title</strong></p> -->                        
                        <li><a href="./reports/rel_categoria.php" target="iframe1" > <?php echo __('Por Categoría','dashboard'); ?> </a></li>                        
                        <li><a href="./reports/rel_data.php" target="iframe1" > <?php echo __('Por Fecha','dashboard'); ?> </a></li> 
                        <li><a href="./reports/rel_entidade.php" target="iframe1" > <?php echo __('Por Entidad','dashboard'); ?> </a></li>
                        <li><a href="./reports/rel_grupo.php" target="iframe1" > <?php echo __('Por Grupo','dashboard'); ?> </a></li>
                        <li><a href="./reports/rel_localidade.php" target="iframe1" > <?php echo __('Por Ubicaciòn','dashboard'); ?> </a></li>
                        <li><a href="./reports/rel_usuario.php" target="iframe1" > <?php echo __('Por Respuesta','dashboard'); ?> </a></li>
                        <li><a href="./reports/rel_tecnico.php" target="iframe1" > <?php echo __('Por Técnico','dashboard'); ?> </a></li>                
                        </li>

								<li class="dropdown-submenu">
		                		<a tabindex="-1" href="#"><?php echo __('Por SLA','dashboard'); ?> </a>
						         <ul class="dropdown-menu">
  								...
  								<li class="dropdown-submenu">
		                		<a tabindex="-1" href="#"><?php echo __('Por OLA','dashboard'); ?> </a>
						         <ul class="dropdown-menu">
            ...
            <li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-bar-chart-o'></i>&nbsp;<?php echo __('Gráficas','dashboard');?>&nbsp;<b class="caret"></b></span></a>
              <ul class="dropdown-menu">                
                  <!-- Content container to add padding -->
                  <div class="yamm-content" style="width:400px;">
                    <div class="row">
                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
                        ...
                        <li><a href="./graphs/geral.php" target="iframe1" > <?php echo __('General','dashboard'); ?></a></li>
                        ...
                        <li><a href="./graphs/usuarios.php" target="iframe1" > <?php echo __('Respuesta','dashboard'); ?> </a></li>
                        <li><a href="./graphs/satisfacao.php" target="iframe1" > <?php echo __('Satisfacción','dashboard'); ?> </a></li>
                        <li><a href="./graphs/tecnicos.php" target="iframe1" > <?php echo __('Técnico','dashboard'); ?> </a></li>
                        <li><a href="./graphs/times.php" target="iframe1" > <?php echo __('Time range'); ?> </a></li>
                      </ul>

                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
                        <li><!-- <p><strong>Links Title</strong></p> --></li>                        
								<li><a href="./graphs/graf_categoria.php" target="iframe1" > <?php echo __('Por Categoría','dashboard'); ?> </a></li>
                        <li><a href="./graphs/geral_mes.php" target="iframe1" > <?php echo __('Por Fecha','dashboard'); ?> </a></li>
                        <li><a href="./graphs/graf_entidade.php" target="iframe1" > <?php echo __('Por Entidad','dashboard'); ?> </a></li>
								<li><a href="./graphs/graf_grupo.php" target="iframe1" > <?php echo __('Por Grupo','dashboard'); ?> </a></li>
								<li><a href="./graphs/graf_localidade.php" target="iframe1" > <?php echo __('Por Ubicación','dashboard'); ?> </a></li>
                        <li><a href="./graphs/graf_usuario.php" target="iframe1" > <?php echo __('Por Respuesta','dashboard'); ?> </a></li>
                        <li><a href="./graphs/graf_tecnico.php" target="iframe1" > <?php echo __('Por Técnico','dashboard'); ?> </a></li>
                        <li><a href="./graphs/graf_tipo.php" target="iframe1" > <?php echo __('Por Tipo','dashboard'); ?> </a></li>
			...
			<li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-line-chart'></i>&nbsp;<?php echo __('Métricas','dashboard');?>&nbsp;<b class="caret"></b></span></a>
              <ul role="menu" class="dropdown-menu">
                <li><a tabindex="-1" href="./metrics/index.php" target="_blank"> <?php echo __('General','dashboard'); ?> </a></li>
                <!--<li><a tabindex="-1" href="./metrics/select_ent.php" target="_blank"> <?php echo __('Por Entidad','dashboard'); ?> </a></li>
                <li><a tabindex="-1" href="./metrics/select_grupo.php" target="_blank">  <?php echo __('Por Grupo','dashboard'); ?> </a></li>    -->            
              </ul>			
			</li>			
