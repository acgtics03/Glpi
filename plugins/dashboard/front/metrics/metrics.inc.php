...
$yesterday = date('Y-m-d', strtotime('-1 día'));
$lastweek = date('Y-m-d', strtotime('-7 días'));
$last15 = date('Y-m-d', strtotime('-15 días'));
$lastmonth = date('Y-m-d', strtotime('-30 días'));
$last3month = date('Y-m-d', strtotime('-90 días'));
$last6month = date('Y-m-d', strtotime('-180 días'));

$datai_m2 = date('Y-m-d', strtotime('-90 días'));
$dataf = date('Y-m-d', strtotime('-365 días'));
