...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta charset="utf-8">
    <title>GLPI  -  <?php echo __('Metricas ACG TICS','dashboard'); ?></title>
...
<div class="col-lg-12" role="main">
	...
	<div class="row-status" >
		<div style="min-height: 0px;" class="col-lg-5 cf-item-status tickets new">
			<header>
				<p><span></span><?php echo _x('status','Nuevos');?></p>
				<!--'New'-->
			</header>
			<div class="content" >
		...
		<div style="min-height: 100px;" class="col-lg-5 cf-item-status tickets assign">
			<header>
				<p><span></span><?php echo __('Asignados');?></p>
				<!--'Assigned'-->
			</header>
			<div class="content">
		...
		if($solved > 0) {
			$notopen = $solved;
			$notopeny = $solvedy;
			$tit_notopen = __('Resueltos','dashboard');
			...
			$notopen = $closed;
			$notopeny = $closedy;
			$tit_notopen = __('Cerrados','dashboard');
			//closed
			$count_notop = strlen($notopen);
		}
		...
		<div style="min-height: 100px;" class="col-lg-5 cf-item-status tickets all">				
			<header>
				<p><span></span><?php echo __('Incidentes')." ".__('','dashboard')."";?></p>
			</header>
			<div class="content">
...
<div class="row" style="margin-top: 10px;">	
		<div style="" class="col-lg-3 cf-item">
			...
			<header>
				<p><span></span><?php echo __('')."". __('Fecha'); ?>
				<!--Time Date-->
				</p>
			</header>
			<div class="content">
				...
				<!-- <div class="cf-td cf-td-12"> -->
					<div class="cf-version metric-small" style="font-size:10px !important;"><?php echo $actent; ?></div>
					...
					<div class="cf-td-dd">
						...
						<script type="text/javascript">
							...
							document.write("<span style='font-size:14px; margin-top: -6px !important;'>" + ds + " " + curr_date + " " + n + " del " + curr_year + "</span><br>" );		
						</script>
						<span style="font-size:10px;"><?php echo __('Period'). ": ".$period_name ?></span>
					</div>					
				</div>
			</div>
			</div> <!-- //end cf-item -->
		...
		<div style="" class="col-lg-3 cf-item">
				<header>
					<p><span></span><?php echo __('Total Casos (S/I)','dashboard');?></p>
				</header>
				<div class="content">
			...
			<div style="min-height: 0px;" class="col-lg-3 cf-item">
				<header>
					<p><span></span><?php echo __('Solicitudes Hoy','dashboard'); ?> </p>
				</header>
				<div class="content">							
				 <div class="cf-svmc-sparkline">
						<div class="cf-svmc">
			...
			<div style="" class="col-lg-3 cf-item">
				<header>
					<p><span></span><?php echo _n('','',2)." ".__('Casos en ','dashboard');?> %</p>
				</header>				
	...
	<div class="row row-fluid" style="margin-top:25px;">														
						
			<div style="" class="col-lg-3 cf-item">
				<header>
					<p><span></span><?php echo __('CASOS TOTALES','dashboard') ;?></p>
				</header>
				<div class="content">
			...
			<div style="" class="col-lg-3 cf-item">
					<header>
						<p><span></span><?php echo _n('','',2)." ". __('TIPOS','dashboard') ;?></p>
					</header>
					<div class="content" >					
			...
			<div style="" class="col-lg-3 cf-item">
				<header>
					<p><span></span><?php echo __('RESUELTOS EN') ;?></p>
				</header>
		...
		<div class="col-xs-3 col-sm-4 col-md-4 col-lg-1 form-group pull-right" style="float: right; width:125px; ">
			<select id="reload_selecter" class="form-control pull-right" style="display: none;">
		...
		<div>
			<button id="reload_page" type="button" class="btn btn-default pull-left">
