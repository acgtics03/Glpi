...
<html>
<head>
    <title>GLPI - Tableros - Inicio </title>
					  ...
					  <div class="col-md-2 col-sm-2">
						 <div class="dashbox shad panel panel-default db-red">
							<div class="panel-body">
               				...
               				<span class="date"><b><?php echo __('Hoy','dashboard'); ?></b></span>												
							   </div>
							</div>
						 </div>
					  </div>
					 ...
					 <div class="col-md-2 col-sm-2">
						 <div class="dashbox shad panel panel-default db-dred">
							<div class="panel-body">
               				...
               				<span class="chamado"><?php echo __('Tickets','dashboard'); ?></span><br>
               				<span class="date"><b><?php echo __('Fuera fecha','dashboard'); ?></b></span>                      				
							   </div>
							</div>
						 </div>
					 </div>	  
						 ...
						 <div class="dashbox shad panel panel-default db-brown">
							<div class="panel-body">
					   		...
					   		<div class="panel-right right">
									...
									<span class="chamado"><?php echo __('Tickets','dashboard'); ?></span><br>
               				<span class="date"><?php echo __('Resueltos','dashboard'); ?></span><br>                        				
							   </div>
							</div>
						 </div>
					  </div>						 					 
						 ...
						 <div class="dashbox shad panel panel-default db-orange">
							<div class="panel-body">
					   		...
					   		<div class="panel-right right">
									...
									<span class="chamado"><?php echo __('Usuarios','dashboard'); ?></span><br>
               			
               				<span class="date"><?php echo __('Activos','dashboard'); ?></span><br>    
							   </div>
							</div>
						 </div>
					</div>						 							  	
...
<div id="tickets_total" class="widget2 widget-table action-table striped" style="margin-top: 10px; ">
   <div class="widget-header2" style="width:100%;">                
   	<h3><i class="fa fa-area-chart" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Evolución de Tickets','dashboard'); ?></h3>      
   </div> 
      <!-- /widget-header -->
			...
			<div id="graflinhas1" class="demo-placeholder" style="float:left; width: <?php echo $width_os; ?> ;"></div>
				...
				<div id="srvinfo">					
					...
					if(file_exists('/etc/hosts')) { 
						...
						echo '<h5 class="label1 label-default" style="margin-top: -5px;"> <i class="fa fa-info-circle"></i>&nbsp;  '. __('Fuente de Información','dashboard').'</h5>
...
<div id="widgets" class="row">	
   ...
   <div id="tickets_status" class="widget widget-table action-table striped card1" >
      <div class="widget-header wred">                 
      	<h3><i class="fa fa-pie-chart" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Tickets por Estados','dashboard'); ?></h3>
   ...
   <div id="last_week" class="widget widget-table action-table striped card1" >
      <div class="widget-header wred">                
      	<h3><i class="fa fa-bar-chart-o" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Tickets')." - ". __('Ultimos 7 días','dashboard') ; ?></h3>
      	 <span  class="fa fa-times hide-widget"></span>             
      </div> 
      <!-- /widget-header -->      
			<div id="graf7"> 
...
<div class="col-sm-6 col-md-6" > 	 				              
   <div id="tickets_age" class="widget widget-table action-table striped card1" >
      <div class="widget-header wpurple">                
      	<h3><i class="fa fa-pie-chart" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Tickets Solucionados por Período','dashboard'); ?></h3>
      	 <span  class="fa fa-times hide-widget"></span>             
      </div> 
      <!-- /widget-header -->
			<div id="graf9"> 			
	...
	<div class="col-sm-6 col-md-6"> 	 				              
   	<div id="tickets_time" class="widget widget-table action-table striped card1" >
	      <div class="widget-header wpurple">                
	      	<h3><i class="fa fa-bar-chart-o" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Tickets Abiertos por Días','dashboard'); ?></h3>
	      	 <span  class="fa fa-times hide-widget"></span>             
	      </div> 
	      <!-- /widget-header -->
			<div id="graf8"> 
	...
	<div class="col-sm-6 col-md-6">	 				              
      ...
      <div class="widget-header wyellow">                
      	<h3><i class="fa fa-list-alt" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><a href="../../../front/ticket.php" target="_blank" style="color: #525252;"><?php echo __('Ultimos Tickets','dashboard'); ?></a></h3>
      	 <span  class="fa fa-times hide-widget"></span>             
      </div> 
      <!-- /widget-header -->
...
<!--  open tickets by tech-->
	<div class="col-sm-6 col-md-6"> 	
		<div id="open_tickets" class="widget widget-table action-table striped card1">
            <div class="widget-header wyellow">
           		<h3><i class="fa fa-list-alt" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><a href="../../../front/ticket.php" target="_blank" style="color: #525252;"><?php echo __('Tickets Abiertos','dashboard'). " " .__(' por Técnicos','dashboard') ?></a></h3>
           		 <span  class="fa fa-times hide-widget"></span>           
            </div>
            <!-- /widget-header -->
...
<div class="col-sm-6 col-md-6" >  	 				              
		 <div id="events" class="widget widget-table action-table striped card1">
            <div class="widget-header wblue">
              <h3><i class="fa fa-list-alt" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><a href="../../../front/event.php" target="_blank" style="color: #525252;"><?php echo __('Ultimos Eventos','dashboard'); ?></a></h3>
               <span  class="fa fa-times hide-widget"></span>
            </div>
            <!-- /widget-header -->
	...
	<div class="col-sm-6 col-md-6" style="margin-rightx:-15px;">  	 				              
		 <div id="logged_users" class="widget widget-table action-table card1">
            <div class="widget-header wblue">
				...
				?>    
           <h3><i class="fa fa-group" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Eventos de Usuarios','dashboard')."  :  " .$num_users; ?></h3>
			   <span  class="fa fa-times hide-widget"></span>
